...
export const dbStore = {
  ...
  createBooking: (payload) => {
    ...
    const newBooking = {
      ...
      tipGratitude: 0.00,
      total,
      workerPayout: Math.round(total * 0.75 * 100) / 100,
      societyFund: Math.round(total * 0.10 * 100) / 100,
      platformFee: Math.round(total * 0.10 * 100) / 100,
  ...
  addExtraCharge: async (bookingId, payload = {}) => {
    ...
    booking.workerPayout = Math.round((totalLabor * 0.75 + (booking.tipGratitude || 0)) * 100) / 100;
    booking.societyFund = Math.round(totalLabor * 0.10 * 100) / 100;
    booking.platformFee = Math.round(totalLabor * 0.10 * 100) / 100;
  ...
  processMockPayment: (bookingId, { tipGratitude = 0 } = {}) => {
    ...
    booking.workerPayout = Math.round((totalLabor * 0.75 + tip) * 100) / 100;
    booking.societyFund = Math.round(totalLabor * 0.10 * 100) / 100;
    booking.platformFee = Math.round(totalLabor * 0.10 * 100) / 100;
    booking.welfareDeposit = Math.round(totalLabor * 0.05 * 100) / 100;
    ...
    return {
      ...
      cooperativeSplit75_10_10_5: {
        workerWallet75: booking.workerPayout,
        societyOperations10: booking.societyFund,
        platformOperations10: booking.platformFee,
